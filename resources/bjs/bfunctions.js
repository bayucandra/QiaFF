...
function bfull_screen(p_el){
    if (p_el.requestFullscreen) {
	p_el.requestFullscreen();
    } else if (p_el.msRequestFullscreen) {
	p_el.msRequestFullscreen();
    } else if (p_el.mozRequestFullScreen) {
	p_el.mozRequestFullScreen();
    } else if (p_el.webkitRequestFullscreen) {
	p_el.webkitRequestFullscreen();
    }
}
